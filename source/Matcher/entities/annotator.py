...
from Matcher.entities.linker import ConceptLinker, LanceDBConceptStore
from Matcher.entities.recognizers import EntityRecognizer, build_recognizer
from Matcher.entities.schemas import load_entity_schemas
from Matcher.entities.types import EntityAnnotation
...
class CompatibilityEntityAnnotator(SchemaEntityAnnotator):
    """Named compatibility shim for old call sites expecting BioMedNER shape."""
