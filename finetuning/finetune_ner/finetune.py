...
import wandb
from utils import NerDataset, Split, get_bio_labels, get_labels
from models import *
...
def main():
    ...
    wandb.init(project="trialmatchai", name=data_args.wandb_name) # need check
    ...
    checkpoint_folders = glob.glob(os.path.join(training_args.output_dir, "checkpoint-*"))
    if checkpoint_folders:
        latest_checkpoint = max(checkpoint_folders, key=os.path.getctime)  # Sort by creation time
    else:
